    ...
    return __awaiter(this, void 0, void 0, function* () {
        ...
        const url = typeof input === 'string'
            ...
            : input instanceof Request
                ? input.url
                : input.toString();
        const method = (init === null || init === void 0 ? void 0 : init.method) || (input instanceof Request ? input.method : 'GET');
        ...
        try {
            ...
            const requestData = {
                ...
                initiator: 'fetch',
                timestamp: Date.now(),
                requestHeaders: (init === null || init === void 0 ? void 0 : init.headers) ? convertHeadersToObject(init.headers) : {}
            };
            ...
            const response = yield originalFetch.apply(window, [input, init]);
            ...
            try {
                const responseBody = yield responseClone.text();
...
function updateNetworkRequest(id, updates) {
    try {
        ...
        if (index !== -1) {
            networkRequests[index] = Object.assign(Object.assign({}, networkRequests[index]), updates);
...
function createDirectNetworkMonitor() {
    try {
        ...
        function logRequest(method, url, type) {
            if (!debugContent)
                return;
...
function setupDirectPostCapture() {
    try {
            ...
            return __awaiter(this, void 0, void 0, function* () {
                ...
                if (method === 'POST') {
                    ...
                    if (isNetworkMonitorActive) {
                        ...
                        const startTime = performance.now();
                        try {
                            const response = yield originalFetchForPost.apply(window, [input, init]);
                            const endTime = performance.now();
        ...
        XMLHttpRequest.prototype.open = function (method, url) {
            ...
            return originalXHROpenForPost.apply(this, arguments);
        };
        XMLHttpRequest.prototype.send = function (body) {
            // Special handling for POST requests
            ...
            return originalXHRSendForPost.apply(this, arguments);
        };
...
function toggleNetworkMonitoring(enabled) {
    ...
    try {
        ...
        if (enabled) {
            ...
            if (networkOverlay) {
                ...
                const highestZ = Math.max(...Array.from(document.querySelectorAll('body *'))
...
function createNetworkOverlay(options) {
    try {
...
function updateNetworkOverlay() {
    try {
        ...
        const emptyMessage = networkOverlay.querySelector('#drishti-empty-message');
        if (!tbody) {
